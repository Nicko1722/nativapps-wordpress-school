...
function nativapps_listar_estudiantes() {
    ?>
    ...
    <div class="wrap">
        ...
        <div class="tablenav top">
            <div class="alignleft actions">
                <a href="<?php echo admin_url('admin.php?page=nativapps_crear_estudiante'); ?>">
                    Crear estudiante
                </a>
            </div>
            <br class="clear">
        ...
        <table class='wp-list-table widefat fixed striped posts'>
            ...
            <?php foreach ($rows as $row) { ?>
                <tr>
                    ...
                    <td>
                        <a href="<?php echo admin_url('admin.php?page=nativapps_actualizar_estudiante&id=' . $row->id); ?>">
                            Modificar
                        </a>
                    </td>
                </tr>
