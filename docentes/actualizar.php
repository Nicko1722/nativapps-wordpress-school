...
function nativapps_actualizar_docente() {
    global $wpdb;
    ...
    <div class="wrap">
        ...
        <?php if ($_POST['delete']) { ?>
            <div class="updated"><p>Docente Eliminado</p></div>
            <a href="<?php echo admin_url('admin.php?page=nativapps_listar_docentes') ?>">&laquo; Volver a la lista de docentes</a>

        <?php } else if ($_POST['update']) { ?>
            <div class="updated"><p>Docente Actualizado</p></div>
            <a href="<?php echo admin_url('admin.php?page=nativapps_listar_docentes') ?>">&laquo; Volver a la lista de docentes</a>
